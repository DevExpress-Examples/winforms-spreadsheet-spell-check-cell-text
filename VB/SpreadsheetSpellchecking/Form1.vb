...
Namespace SpreadsheetSpellchecking
    ...
    Public Partial Class Form1
        ...
        Public Sub New()
            ...
            Me.BarManager.QueryShowPopupMenu += AddressOf OnBarManager_QueryShowPopupMenu
            Me.spreadsheetControl.CellEditorOpened += AddressOf OnSpreadsheetControl_CellEditorOpened
        End Sub
        ...
        Private Sub OnBarManager_QueryShowPopupMenu(ByVal sender As Object, ByVal e As QueryShowPopupMenuEventArgs)
            ...
            Try
                ...
                For Each command As SpellCheckerCommand In commands
                    ...
                    item.Tag = command
                    item.ItemClick += AddressOf OnPopupMenu_ItemClick
                    itemLinks.Add(item)
                Next

                Dim itemShowSpellingForm As BarButtonItem = New BarButtonItem(BarManager, "Show Spelling Form")
                itemShowSpellingForm.ItemClick += AddressOf OnPopupMenuShowSpellingForm_ItemClick
